...
### 1.5.0
* `SearchResultsNotification` has been extended with more failure information, including the number of times a failed search has been attempted thus far, and how many attempts remain.
  * As part of this enhancement, the property `FailureMessage` has been superseded by a new property `FailureInfo`.
