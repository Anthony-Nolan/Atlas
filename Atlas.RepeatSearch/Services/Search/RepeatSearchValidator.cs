...
namespace Atlas.RepeatSearch.Services.Search
{
    public interface IRepeatSearchValidator
    {
        ...
        /// </summary>
        public Task ValidateRepeatSearch(RepeatSearchRequest repeatSearchRequest);
    }
    ...
    internal class RepeatSearchValidator : IRepeatSearchValidator
    {
        ...
        public async Task ValidateRepeatSearch(RepeatSearchRequest repeatSearchRequest)
        {
