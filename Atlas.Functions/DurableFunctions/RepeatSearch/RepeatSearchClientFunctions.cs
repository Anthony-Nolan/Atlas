...
namespace Atlas.Functions.DurableFunctions.RepeatSearch
{
    /// <summary>
    ...
    /// </summary>
    public class RepeatSearchClientFunctions
    {
        private readonly ILogger logger;
        private readonly IMatchPredictionAlgorithm matchPredictionAlgorithm;

        public RepeatSearchClientFunctions(IMatchPredictionAlgorithm matchPredictionAlgorithm, ILogger logger)
        {
            ...
            [DurableClient] IDurableOrchestrationClient starter)
        {
            ...
            var instanceId = await starter.StartNewAsync(nameof(RepeatSearchOrchestrationFunctions.RepeatSearchOrchestrator), resultsNotification);
