...
namespace Atlas.Functions.DurableFunctions.RepeatSearch
{
    ...
    public class RepeatSearchOrchestrationFunctions
    {
        ...
        private static async Task SendFailureNotification(IDurableOrchestrationContext context, string failedStage, string searchId)
        {
            ...
            context.SetCustomStatus($"Repeat Search failed, during stage: {failedStage}");
        }
    }
}
