...
namespace Atlas.MatchingAlgorithm.Test.Services.Search.Scoring.Aggregation
{
    ...
    public class ScoreResultAggregatorTests
    {
        ...
        // Unknown & Unknown case is not valid, as it would lead to a "Potential" confidence, not a "Mismatch" one.
        [TestCase(MatchGrade.Unknown, MatchGrade.Mismatch, MatchCategory.Mismatch)]
        [TestCase(MatchGrade.Unknown, MatchGrade.PermissiveMismatch, MatchCategory.PermissiveMismatch)]
