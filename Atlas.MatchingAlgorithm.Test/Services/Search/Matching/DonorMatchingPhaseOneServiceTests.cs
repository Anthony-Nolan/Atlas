...
{
    [TestFixture]
    public class DonorMatchingPhaseOneServiceTests
    {
        ...
        private IDonorMatchingPhaseOneService matchingPhaseOneService;
        ...
        public void SetUp()
        {
            var donorSearchRepository = Substitute.For<IDonorSearchPhaseOneRepository>();
            ...
            repositoryFactory.GetDonorSearchPhaseOneRepository().Returns(donorSearchRepository);
            repositoryFactory.GetPGroupRepository().Returns(pGroupRepository);

            matchingPhaseOneService = new DonorMatchingPhaseOneService(repositoryFactory, matchFilteringService, databaseFilteringAnalyser, Substitute.For<ILogger>());
        ...
        public async Task FindMatchesForLoci_WhenTwoMatchesRequired_ReturnsExactMatch()
        {
            ...
            var results = (await matchingPhaseOneService.FindMatchesForLoci(criteria, loci)).ToList();
