...
output "function_app" {
  value = {
    ...
    app_name = "${var.general.environment}-ATLAS-MATCHING-ALGORITHM-FUNCTION"
    donor_matching_app_name = "${var.general.environment}-ATLAS-MATCHING-DONOR-MANAGEMENT-FUNCTION"
  }
}
