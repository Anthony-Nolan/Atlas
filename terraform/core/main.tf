...
module "match_prediction" {
  ...
  MESSAGING_BUS_MATCH_PREDICTION_BATCH_SIZE           = var.MATCH_PREDICTION_MESSAGING_BUS_REQUEST_BATCH_SIZE
  MESSAGING_BUS_MATCH_PREDICTION_CRON_SCHEDULE        = var.MATCH_PREDICTION_MESSAGING_BUS_REQUEST_CRON_SCHEDULE
  SUPPRESS_COMPRESSED_PHENOTYPE_CONVERSION_EXCEPTIONS = var.MATCH_PREDICTION_SUPPRESS_COMPRESSED_PHENOTYPE_CONVERSION_EXCEPTIONS
  WEBSITE_RUN_FROM_PACKAGE                            = var.WEBSITE_RUN_FROM_PACKAGE
}
