...
module "donor_import" {
  ...
  DONOR_ID_CHECKER_RESULTS_SUBSCRIPTION_NAMES   = var.DONOR_ID_CHECKER_RESULTS_SUBSCRIPTION_NAMES
  DONOR_INFO_CHECKER_RESULTS_SUBSCRIPTION_NAMES = var.DONOR_INFO_CHECKER_RESULTS_SUBSCRIPTION_NAMES
  ...
  PUBLISHED_UPDATES_TO_DELETE_CAP               = var.DONOR_IMPORT_PUBLISHED_UPDATES_TO_DELETE_CAP
  PUBLISHED_UPDATES_TO_DELETE_BATCH_SIZE        = var.DONOR_IMPORT_PUBLISHED_UPDATES_TO_DELETE_BATCH_SIZE
...
module "matching_algorithm" {
  ...
  DATA_REFRESH_LEASE_DURATION_MINUTES                      = var.MATCHING_DATA_REFRESH_LEASE_DURATION_MINUTES
  DATA_REFRESH_LEASE_RENEWAL_INTERVAL_SECONDS              = var.MATCHING_DATA_REFRESH_LEASE_RENEWAL_INTERVAL_SECONDS
  DATA_REFRESH_CRONTAB                                     = var.MATCHING_DATA_REFRESH_CRONTAB
  DATA_REFRESH_WATCHDOG_CRON_SCHEDULE                      = var.MATCHING_DATA_REFRESH_WATCHDOG_CRON_SCHEDULE
  DATA_REFRESH_WATCHDOG_GRACE_DURATION_MINUTES             = var.MATCHING_DATA_REFRESH_WATCHDOG_GRACE_DURATION_MINUTES
...
module "match_prediction" {
  ...
  CONTAINER_SCALE_RULE_POLLING_INTERVAL_SECONDS            = var.MATCH_PREDICTION_CONTAINER_SCALE_RULE_POLLING_INTERVAL_SECONDS
...
module "repeat_search" {
  ...
  RESULTS_BATCH_SIZE                                       = var.RESULTS_BATCH_SIZE
  SEARCH_RELATED_HLA_METADATA_CACHE_SLIDING_EXPIRATION_SEC = var.REPEAT_SEARCH_SEARCH_RELATED_HLA_METADATA_CACHE_SLIDING_EXPIRATION_SEC
  SERVICE_BUS_SEND_RETRY_COOLDOWN_SECONDS                  = var.SERVICE_BUS_SEND_RETRY_COOLDOWN_SECONDS
  SERVICE_BUS_SEND_RETRY_COUNT                             = var.SERVICE_BUS_SEND_RETRY_COUNT
