...
module "matching_algorithm" {
  ...
  HLA_CACHE_SLIDING_EXPIRATION_SEC                 = var.MATCHING_ALGORITHM_HLA_CACHE_SLIDING_EXPIRATION_SEC
}
...
module "match_prediction" {
  ...
  WEBSITE_RUN_FROM_PACKAGE         = var.WEBSITE_RUN_FROM_PACKAGE
  HLA_CACHE_SLIDING_EXPIRATION_SEC = var.MATCH_PREDICTION_HLA_CACHE_SLIDING_EXPIRATION_SEC
}
...
module "repeat_search" {
  ...
  RESULTS_BATCH_SIZE                             = var.RESULTS_BATCH_SIZE
  HLA_CACHE_SLIDING_EXPIRATION_SEC               = var.REPEAT_SEARCH_HLA_CACHE_SLIDING_EXPIRATION_SEC
}
