...
variable "SEARCH_RESULTS_READY_SUBSCRIPTION_NAMES" {
  type        = list(string)
  default     = []
  descripton  = "Subscription names for the search-results-ready Service Bus topic (in addition to Audit subscription). If not provided, no additional subscriptions will be created."
}
