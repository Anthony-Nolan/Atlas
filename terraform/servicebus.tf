...
resource "azurerm_servicebus_topic" "notifications" {
  ...
  auto_delete_on_idle   = locals.long-expiry
  default_message_ttl   = locals.long-expiry
  max_size_in_megabytes = locals.default-bus-size
}
...
resource "azurerm_servicebus_subscription" "donor-update" {
  ...
  auto_delete_on_idle                  = locals.long-expiry
  default_message_ttl                  = locals.long-expiry
  lock_duration                        = locals.default-read-lock
  max_delivery_count                   = locals.default-message-retries
...
resource "azurerm_servicebus_subscription" "audit-notifications" {
  ...
  auto_delete_on_idle                  = locals.audit-subscription-idle-delete
  default_message_ttl                  = locals.long-expiry
  lock_duration                        = locals.default-read-lock
  max_delivery_count                   = locals.default-message-retries
  dead_lettering_on_message_expiration = false
