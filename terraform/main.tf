...
module "matching_algorithm" {
  ...
  MATCHING_DATA_REFRESH_DB_SIZE_ACTIVE                      = var.MATCHING_DATA_REFRESH_DB_SIZE_ACTIVE
  MATCHING_DATA_REFRESH_DB_SIZE_DORMANT                     = var.MATCHING_DATA_REFRESH_DB_SIZE_DORMANT
  MATCHING_DATA_REFRESH_DB_SIZE_REFRESH                     = var.MATCHING_DATA_REFRESH_DB_SIZE_REFRESH
  MATCHING_DATA_REFRESH_DONOR_IMPORT_FUNCTION_NAME          = var.MATCHING_DATA_REFRESH_DONOR_IMPORT_FUNCTION_NAME
  MATCHING_DATA_REFRESH_CRONTAB                             = var.MATCHING_DATA_REFRESH_CRONTAB
  MATCHING_DATABASE_OPERATION_POLLING_INTERVAL_MILLISECONDS = var.MATCHING_DATABASE_OPERATION_POLLING_INTERVAL_MILLISECONDS
  MATCHING_DATABASE_PASSWORD                                = var.MATCHING_DATABASE_PASSWORD
  MATCHING_DATABASE_USERNAME                                = var.MATCHING_DATABASE_USERNAME
  MATCHING_FUNCTION_HOST_KEY                                = var.MATCHING_FUNCTION_HOST_KEY
  MATCHING_MESSAGING_BUS_DONOR_BATCH_SIZE                   = var.MATCHING_MESSAGING_BUS_DONOR_BATCH_SIZE
  MATCHING_MESSAGING_BUS_DONOR_CRON_SCHEDULE                = var.MATCHING_MESSAGING_BUS_DONOR_CRON_SCHEDULE
