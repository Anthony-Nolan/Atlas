...
namespace Nova.SearchAlgorithm.Config
{
    ...
    {
        public static void ConfigureValidation(this HttpConfiguration config)
        {
            ...
            ValidatorOptions.PropertyNameResolver = (type, memberInfo, expression) =>
            {
                ...
                var nameParts = baseResolver(type, memberInfo, expression).Split(new[] { sep }, StringSplitOptions.RemoveEmptyEntries);
