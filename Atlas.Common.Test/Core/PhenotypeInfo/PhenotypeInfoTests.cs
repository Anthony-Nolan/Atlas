...
namespace Atlas.Common.Test.Core.PhenotypeInfo
{
    ...
    public class PhenotypeInfoTests
    {
        ...
        public void GetAtPosition_GetsValuesAtSpecifiedPositionForAllLoci()
        {
            ...
            phenotypeInfo.A = phenotypeInfo.A.SetAtPosition(LocusPosition.One, testDataA1);
            ...
            phenotypeInfo.A = phenotypeInfo.A.SetAtPosition(LocusPosition.Two, testDataA2);
            ...
            phenotypeInfo.B = phenotypeInfo.B.SetAtPosition(LocusPosition.One, testDataB1);
            ...
            phenotypeInfo.B = phenotypeInfo.B.SetAtPosition(LocusPosition.Two, testDataB2);
            ...
            phenotypeInfo.C = phenotypeInfo.C.SetAtPosition(LocusPosition.One, testDataC1);
            ...
            phenotypeInfo.C = phenotypeInfo.C.SetAtPosition(LocusPosition.Two, testDataC2);
            ...
            phenotypeInfo.Drb1 = phenotypeInfo.Drb1.SetAtPosition(LocusPosition.One, testDataDrb11);
            ...
            phenotypeInfo.Drb1 = phenotypeInfo.Drb1.SetAtPosition(LocusPosition.Two, testDataDrb12);
            ...
            phenotypeInfo.Dqb1 = phenotypeInfo.Dqb1.SetAtPosition(LocusPosition.One, testDataDqb11);
            ...
            phenotypeInfo.Dqb1 = phenotypeInfo.Dqb1.SetAtPosition(LocusPosition.Two, testDataDqb12);
            ...
            phenotypeInfo.Dpb1 = phenotypeInfo.Dpb1.SetAtPosition(LocusPosition.One, testDataDpb11);
            ...
            phenotypeInfo.Dpb1 = phenotypeInfo.Dpb1.SetAtPosition(LocusPosition.Two, testDataDpb12);
        ...
        public void Reduce_ReducesAllPositionValues()
        {
            ...
            {
                A = new LocusInfo<int>(1, 2),
                B = new LocusInfo<int>(3, 4),
                C = new LocusInfo<int>(5, 6),
                Dpb1 = new LocusInfo<int>(7, 8),
                Dqb1 = new LocusInfo<int>(9, 10),
                Drb1 = new LocusInfo<int>(11, 12),
            };
        ...
        public void Equality_WhenObjectsAreDifferent_ReportsNonEquality()
        {
            ...
            var different = new PhenotypeInfo<int>
            {
                ...
                B = new LocusInfo<int>(3, 4),
                C = new LocusInfo<int>(5, 6),
                Dpb1 = new LocusInfo<int>(7, -1), //Different Here.
                Dqb1 = new LocusInfo<int>(9, 10),
                Drb1 = new LocusInfo<int>(11, 12),
            };
        ...
        public void Equality_WhenObjectsContainNulls_DoesNotError()
        {
            ...
            {
                A = new LocusInfo<int?>(null, 2),
                B = new LocusInfo<int?>(3, null),
                C = new LocusInfo<int?>(null, null),
                //Dpb1 = ,
                Dqb1 = new LocusInfo<int?>(9, 10),
                Drb1 = new LocusInfo<int?>(11, 12),
            };
            ...
            var different = new PhenotypeInfo<int?>
            {
                A = new LocusInfo<int?>(1, null), // nullity is inverse of same1
                B = new LocusInfo<int?>(3, null), // nullity matches same1
                //C = ,                                                            // This default, same1 all null
                Dpb1 = new LocusInfo<int?>(null, null), // This all null, same1 default
                Dqb1 = new LocusInfo<int?>(null, null),
                //Drb1 = ,
            };
