...
namespace Nova.Utils.PhenotypeInfo
{
    ...
    public class PhenotypeInfo<T> : LociInfo<LocusInfo<T>>
    {
        ...
        // These properties are currently used in the frontend - NOVA-4578 tracks removing them there.
        // Once this has been completed, they can be removed here as well.
        [Obsolete("Use LocusInfo directly instead")]
        public T A_1
        {
            get
            {
