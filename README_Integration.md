...
These are currently hard-coded into the host.json file, to change this per installation would require either a fork of the codebase, or a change to make this configurable.
