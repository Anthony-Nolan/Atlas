...
namespace Nova.SearchAlgorithm.Data.Repositories
{
    ...
    public interface IDataRefreshRepository
    {
        ...
        Task<IBatchQueryAsync<InputDonor>> DonorsAddedSinceLastHlaUpdate(int batchSize);
    ...
    public class DataRefreshRepository : Repository, IDataRefreshRepository
    {
        ...
        public async Task<IBatchQueryAsync<InputDonor>> DonorsAddedSinceLastHlaUpdate(int batchSize)
        {
