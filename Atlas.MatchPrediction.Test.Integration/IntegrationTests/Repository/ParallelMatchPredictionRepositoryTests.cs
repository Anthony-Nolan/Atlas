...
/// abandonment — ATL-111), dispatch-failure recording (ATL-151), abandonment sweeps, finalisation eligibility,
/// and retention clean-up.
/// </summary>
[TestFixture]
public class ParallelMatchPredictionRepositoryTests
{
    ...
    // ── MarkRunAsDispatchFailed ──────────────────────────────────────────────────

    [Test]
    public async Task MarkRunAsDispatchFailed_MarksAllBatchesFailedAndLeavesRunRunning()
    {
