...
//
//             var likelihoodResponse = await likelihoodService.CalculateLikelihood(genotypeInput, allLoci);
//
...
//                 .Build();
//
//             var likelihoodResponse = await likelihoodService.CalculateLikelihood(genotype, allLoci);
//
...
//
//             var likelihoodResponse = await likelihoodService.CalculateLikelihood(genotype, allowedLoci);
//
//             likelihoodResponse.Should().Be(expectedLikelihood);
//         }
//
