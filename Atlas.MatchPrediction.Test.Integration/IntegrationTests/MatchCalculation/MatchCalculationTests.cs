...
namespace Atlas.MatchPrediction.Test.Integration.IntegrationTests.MatchCalculation
{
    ...
    public class MatchCalculationTests
    {
        ...
        [Test]
        public async Task MatchAtPGroupLevel_WhenPatientGenotypeHomozygous_AndMatchesExactlyOneOfPatientHla_IsTenOutOfTenMatch()
        {
        ...
        [Test]
        public async Task MatchAtPGroupLevel_WhenDonorGenotypeHomozygous_AndMatchesExactlyOneOfDonorHla_IsNotTenOutOfTenMatch()
        {
            var donorGenotype = NewGenotype
                .With(g => g.B, new LocusInfo<string> {Position1 = B1, Position2 = B1 }).Build();
