...
namespace Atlas.DonorImport.Services
{
    internal interface IDonorRecordChangeApplier
    {
        ...
        Task ApplyDonorOperationBatch(UpdateMode updateMode, IReadOnlyCollection<DonorUpdate> donorUpdates);
    }
    ...
    internal class DonorRecordChangeApplier : IDonorRecordChangeApplier
    {
        ...
        public async Task ApplyDonorOperationBatch(UpdateMode updateMode, IReadOnlyCollection<DonorUpdate> donorUpdates)
        {
