...
namespace Atlas.MatchingAlgorithm.Test.Validation.ValidationTests.Features.NullAlleles
{
    ...
    [NUnit.Framework.DescriptionAttribute("Scoring - Expressing Typing vs. Null Allele - Match Confidence")]
    public partial class Scoring_ExpressingTypingVs_NullAllele_MatchConfidenceFeature
    {
...
#line 1 "MatchConfidence.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "ValidationTests/Features/NullAlleles", "Scoring - Expressing Typing vs. Null Allele - Match Confidence", "  As a member of the search team\r\n  I want search results to correctly handle the" +
                    " scoring of a locus that contains a null allele.", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Homozygous locus vs Null-allele containing locus are matched at expressing typing" +
            "")]
        public void HomozygousLocusVsNull_AlleleContainingLocusAreMatchedAtExpressingTyping()
        {
...
#line hidden
#line 15
    testRunner.Then("the match confidence should be not-mismatch at locus C at both positions", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
        ...
        [NUnit.Framework.DescriptionAttribute("Homozygous locus vs Null-allele containing locus are allele mismatched at express" +
            "ing typing")]
        public void HomozygousLocusVsNull_AlleleContainingLocusAreAlleleMismatchedAtExpressingTyping()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Homozygous locus vs Null-allele containing locus are allele mismatched at express" +
                    "ing typing", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 17
  this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
#line 27
    testRunner.Then("the match confidence should be mismatch at locus C at both positions", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        ...
        [NUnit.Framework.DescriptionAttribute("Homozygous locus vs Null-allele containing locus are antigen mismatched at expres" +
            "sing typing")]
        public void HomozygousLocusVsNull_AlleleContainingLocusAreAntigenMismatchedAtExpressingTyping()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Homozygous locus vs Null-allele containing locus are antigen mismatched at expres" +
                    "sing typing", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 29
  this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Homozygous DPB1 vs Null-allele containing DPB1 are permissively mismatched at exp" +
            "ressing typing")]
        public void HomozygousDPB1VsNull_AlleleContainingDPB1ArePermissivelyMismatchedAtExpressingTyping()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Homozygous DPB1 vs Null-allele containing DPB1 are permissively mismatched at exp" +
                    "ressing typing", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 41
  this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
#line 51
 testRunner.Then("the match confidence should be mismatch at locus DPB1 at both positions", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
