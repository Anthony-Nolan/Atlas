Feature: Scoring - Expressing Typing vs. Null Allele - Match Grade
  ...
  Scenario: Homozygous locus vs Null-allele containing locus are matched at expressing typing
    ...
    Then the match grade should be molecular-match in position 1 and expressing-vs-null in position 2 of locus C
  ...
  Scenario: Homozygous locus vs Null-allele containing locus are allele mismatched at expressing typing
    ...
    And scoring is enabled at locus C
    When I run a 6/6 search
    Then the match grade should be mismatch in position 1 and expressing-vs-null in position 2 of locus C
  ...
  Scenario: Homozygous DPB1 vs Null-allele containing DPB1 are permissively mismatched at expressing typing
	...
	When I run a 6/6 search
	Then the match grade should be mismatch in position 1 and expressing-vs-null in position 2 of locus DPB1