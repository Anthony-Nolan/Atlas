...
[Log files](/Atlas.Client.Models/Search/Results/RequestPerformanceMetrics.cs) named `{search-request-id}-log.json` are uploaded to `matching-algorithm-results` and `atlas-search-results` containers. 
