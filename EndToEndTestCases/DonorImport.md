...
|3. Check the `donor-import-results` topic on `<env>-atlas` service bus | There should be a success donor import message with next properties:<br> - FileName,<br> - WasSuccessful (true or false),<br> - ImportedDonorCount (total number of donors imported from the file),<br> - FailedDonorCount (total number of donors that failed to be imported from the file) |
...
|4. Check the `donor-import-results` topic on `<env>-atlas` service bus | There should be a success donor import message with next properties:<br> - FileName,<br> - WasSuccessful (true or false),<br> - ImportedDonorCount (total number of donors imported from the file),<br> - FailedDonorCount (total number of donors that failed to be imported from the file) |
