namespace Atlas.MatchingAlgorithm.Data.Models.Entities
{
    ...
    /// at most 4 rows per donor. Populated by the precompute service; no caller reads it yet.
    /// </summary>
    public class DonorSubjectGenotypeSet
    {
        ...
        /// No DB-level FK, so the writer must populate it with the correct <c>Donors.DonorId</c>.
        /// </summary>
        ...
        /// normalisation), so the writer is responsible for referential integrity.
        /// </summary>
