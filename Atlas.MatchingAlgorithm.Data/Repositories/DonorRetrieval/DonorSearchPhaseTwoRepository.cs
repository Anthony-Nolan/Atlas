...
{
    public class DonorSearchPhaseTwoRepository : Repository, IDonorSearchPhaseTwoRepository
    {
        public DonorSearchPhaseTwoRepository(IConnectionStringProvider connectionStringProvider) : base(connectionStringProvider)
        {
        }
