...
{
    public class DonorSearchPhaseOneRepository : Repository, IDonorSearchPhaseOneRepository
    {
        private readonly ILogger logger;

        public DonorSearchPhaseOneRepository(IConnectionStringProvider connectionStringProvider, ILogger logger) : base(connectionStringProvider)
        {
            this.logger = logger;
        }
