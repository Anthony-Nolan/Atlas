...
namespace Atlas.MatchPrediction.Test.Services.GenotypeLikelihood
{
    ...
    public class GenotypeImputationTests
    {
        ...
        public void GetPossibleDiplotypes_WhenGenotypeHasAllLociAndNoHomozygousCases_Returns16Diplotypes()
        {
            ...
            var actualDiplotypes = genotypeImputation.GetPossibleDiplotypes(genotype);
        ...
        [Test, Repeat(10000), Ignore("Only used for manual benchmarking. Ran in ~390ms")]
        public void PerformanceTest()
        {
            ...
            genotypeImputation.GetPossibleDiplotypes(genotypeWithAllFields);
            ...
            genotypeImputation.GetPossibleDiplotypes(genotypeWithMissingField);
            ...
            genotypeImputation.GetPossibleDiplotypes(genotypeWithHomozygousType);
            ...
            genotypeImputation.GetPossibleDiplotypes(genotypeWithHomozygousTypeAndMissingField);
        }
    }
}
