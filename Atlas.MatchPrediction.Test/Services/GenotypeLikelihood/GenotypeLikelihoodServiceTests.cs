    ...
    public class GenotypeLikelihoodServiceTests
    {
        ...
        public void SetUp()
        {
            ...
            genotypeImputer.ImputeGenotype(Arg.Any<PhenotypeInfo<string>>())
                .Returns(new ImputedGenotype
                {
                    Diplotypes = new List<Diplotype>
                    {
                        new Diplotype
                        {Item1 = new Haplotype {Hla = new LociInfo<string>()}, Item2 = new Haplotype {Hla = new LociInfo<string>()}}
                    }
                });
            ...
            likelihoodCalculator.CalculateLikelihood(Arg.Any<ImputedGenotype>())
                .Returns(0);
        ...
        [TestCase(0.234534)]
        [TestCase(13.23453)]
        public async Task CalculateLikelihood_ReturnsResponseWithLikelihood(decimal expectedLikelihood)
        {
            likelihoodCalculator.CalculateLikelihood(Arg.Any<ImputedGenotype>())
