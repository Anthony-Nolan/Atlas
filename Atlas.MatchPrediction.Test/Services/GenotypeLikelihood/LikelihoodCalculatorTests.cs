...
namespace Atlas.MatchPrediction.Test.Services.GenotypeLikelihood
{
    public class LikelihoodCalculatorTests
    {
        ...
        {
            var hlaInfo1 = new LociInfo<string> { A = "A-2", B = "B-1", C = "C-1", Dqb1 = "Dqb1-1", Drb1 = "Drb1-1"};
            var hlaInfo2 = new LociInfo<string> { A = "A-1", B = "B-2", C = "C-2", Dqb1 = "Dqb1-2", Drb1 = "Drb1-2" };
            ...
            var actualLikelihood = likelihoodCalculator.CalculateLikelihood(homozygousImputedGenotype);
