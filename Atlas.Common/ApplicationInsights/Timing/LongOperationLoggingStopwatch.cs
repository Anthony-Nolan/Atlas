...
namespace LoggingStopwatch
{
    ...
    public class LongOperationLoggingStopwatch : LoggingStopwatch, ILongOperationLoggingStopwatch
    {
        ...
        private static void LogPerExecutionMessageIfAppropriate(LongLoggingSettings settings, int newCompletedCount, Stopwatch outerStopwatch, Action<string, long?> logAction)
        {
