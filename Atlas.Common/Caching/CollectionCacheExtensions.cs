...
namespace Atlas.Common.Caching
{
    ...
    public static class CollectionCacheExtensions
    {
        ...
        // TODO: ATLAS-651: Decide what to do about this - makes integration tests awkward, and isn't necessarily a good feature...
        /// <summary>
        ...
        ///
        /// In practice we have increased this number to allow for more usages of this helper:
        ///     - two HLA Metadata Dictionary caches in integration tests as well
        ///     - caches of consolidated haplotype frequency values when excluding loci - one per HF set
        ...
        /// </summary>
        private const int MaxCollectionCaches = 1028;
