...
### Allele groups
G group - alleles that share the same DNA sequence at the ARS region.
P group - alleles that share the same protein sequence at the ARS region - excludes null alleles, as they do not result in a protein.
Small g group - alleles that share the same protein sequence at the ARS region - includes null alleles.
