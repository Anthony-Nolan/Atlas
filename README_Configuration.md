...
| DONOR_IMPORT_ALLOW_FULL_MODE_IMPORT | DonorImport-AllowFullModeImport | Controls whether Full mode donor import files will be accepted (true) or rejected (false) |
