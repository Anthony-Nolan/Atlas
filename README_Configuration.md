...
| MATCHING-DATA-REFRESH-DB-SIZE_REFRESH | ATLAS-MATCHING-ALGORITHM-FUNCTIONS | DataRefresh-DormantDatabaseSize | The size of database used for the matching database during the data refresh. Recommended to be fairly powerful to facilitate a fast data refresh. Premium tier recommended over Standard, for improved IO performance. |
