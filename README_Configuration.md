...
| SEARCH_RESULTS_READY_SUBSCRIPTION_NAMES| N/A | N/A | Subscription names for the search-results-ready Service Bus topic (in addition to Audit subscription). If not provided, no additional subscriptions will be created. |
