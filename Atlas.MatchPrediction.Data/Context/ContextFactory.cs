...
{
    public class ContextFactory : IDesignTimeDbContextFactory<MatchPredictionContext>
    {
        // This method is called by entity framework to create a context when generating/running migrations
        public MatchPredictionContext CreateDbContext(string[] args)
        {
        ...
        public MatchPredictionContext Create(string connectionString)
        {
