...
namespace Nova.SearchAlgorithm.Config.Modules
{
    public class ServiceModule : Module
    {
        ...
        private static void RegisterMatchingDictionaryTypes(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<MatchingDictionary.Services.HlaMatchPreCalculation.HlaMatchingLookupResultGenerator>().AsImplementedInterfaces().InstancePerLifetimeScope();
