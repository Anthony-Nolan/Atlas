...
{
    internal class DnaToSerologyMapper
    {
        public IList<DnaToSerologyMapping> GetSerologyMappingsForAllele(IHlaInfoToMapDnaToSerology hlaInfo, AlleleTyping alleleTyping)
        {
