...
{
    public interface IDonorMatchingPhaseTwoService
    {
    ...
    public class DonorMatchingPhaseTwoService : DonorMatchingServiceBase, IDonorMatchingPhaseTwoService
    {
        private readonly IDonorSearchPhaseTwoRepository donorSearchRepository;
        private readonly IMatchFilteringService matchFilteringService;
        private readonly IPGroupRepository pGroupRepository;

        public DonorMatchingPhaseTwoService(
            IActiveRepositoryFactory repositoryFactory,
            IMatchFilteringService matchFilteringService
        )
        {
            donorSearchRepository = repositoryFactory.GetDonorSearchPhaseTwoRepository();
