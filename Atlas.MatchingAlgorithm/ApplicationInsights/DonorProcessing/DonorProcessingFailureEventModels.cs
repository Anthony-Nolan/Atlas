...
namespace Atlas.MatchingAlgorithm.ApplicationInsights.DonorProcessing
{
    ...
    public class DonorHlaLookupFailureEventModel : DonorProcessingFailureEventModel
    {
        ...
        {
            var hmdException = exception.Exception;
            Properties.Add("Locus", hmdException.Locus);
            Properties.Add("HlaName", hmdException.HlaName);
            Properties.Add("InnerExceptionType", hmdException.InnerException?.GetType().Name ?? "N/A");
        }
    }
