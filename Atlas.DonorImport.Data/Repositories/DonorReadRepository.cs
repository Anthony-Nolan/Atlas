    ...
    public class DonorReadRepository : DonorRepositoryBase, IDonorReadRepository
    {
        ...
        public IEnumerable<Donor> StreamAllDonors()
        {
            ...
            using (var connection = new SqlConnection(ConnectionString))
            {
                ...
                // This is necessary because we have issues running out of memory on a dataset only slightly larger than AN's average dataset.
                ...
                //yuck :( Unfortunately, if you don't do this, then the connection gets closed as soon as
