...
{
    [TestFixture]
    public class DonorOperationApplierTests
    {
        ...
        public void SetUp()
        {
            ...
            donorOperationApplier = new DonorOperationApplier(donorRepository, messagingServiceBusClient);
        }
        ...
        public async Task ApplyDonorOperationBatch_WithCreationsOnly_WritesBatchToDatabase()
        {
            ...
            await donorOperationApplier.ApplyDonorOperationBatch(UpdateMode.Differential, donorUpdates);
        ...
        public async Task ApplyDonorOperationBatch_ForInitialUpdate_DoesNotPostMatchingUpdates()
        {
            ...
            await donorOperationApplier.ApplyDonorOperationBatch(UpdateMode.Initial, donorUpdates);
