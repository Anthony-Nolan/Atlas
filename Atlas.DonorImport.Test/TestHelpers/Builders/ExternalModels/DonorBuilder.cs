...
public static class DonorBuilder
{
    ...
    public static IPostprocessComposer<Donor> New => FixtureBuilder.For<Donor>()
    ...
    public static IPostprocessComposer<Donor> WithDefaultValidHla(this IPostprocessComposer<Donor> builder, string defaultHla) => builder
