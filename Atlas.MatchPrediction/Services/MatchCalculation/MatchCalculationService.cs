    ...
    internal class MatchCalculationService : IMatchCalculationService
    {
            ...
            ISet<Locus> allowedDonorLoci)
        {
            ...
            var patientGenotypeAsSinglePGroups =
                await locusHlaConverter.ConvertGroupsToPGroups(patientGenotype, hlaNomenclatureVersion, allowedPatientLoci);

            var donorGenotypeAsSinglePGroups =
                await locusHlaConverter.ConvertGroupsToPGroups(donorGenotype, hlaNomenclatureVersion, allowedDonorLoci);
