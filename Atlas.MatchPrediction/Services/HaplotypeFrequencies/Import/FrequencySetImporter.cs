...
namespace Atlas.MatchPrediction.Services.HaplotypeFrequencies.Import
{
    ...
    internal class FrequencySetImporter : IFrequencySetImporter
    {
        ...
        private readonly IFrequencySetValidity frequencySetValidity;
        ...
        public FrequencySetImporter(
            ...
            IFrequencySetValidity frequencySetValidity,
            ILogger logger)
        {
            ...
            this.frequencySetValidity = frequencySetValidity;
            this.logger = logger;
        }
        ...
        public async Task Import(FrequencySetFile file, bool convertToPGroups)
        {
            ...
            frequencySetValidity.Validate(frequencySet);
