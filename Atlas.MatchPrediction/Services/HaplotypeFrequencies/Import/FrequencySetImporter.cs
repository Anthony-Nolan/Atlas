...
{
    public class FrequencySetImportConfig
    {
        /// <summary>
    ...
    {
        Task Import(FrequencySetFile file, FrequencySetImportConfig importConfig);
    }
    ...
    internal class FrequencySetImporter : IFrequencySetImporter
    {
        ...
        public async Task Import(FrequencySetFile file, FrequencySetImportConfig importConfig)
        {
            ...
            await StoreFrequencies(
                ...
                setIds,
                importConfig.ShouldConvertLargeGGroupsToPGroups,
                frequencySetTypingCategory,
                importConfig.ShouldBypassHlaValidation);
            ...
            bool bypassHlaValidation)
        {
            ...
            if (!bypassHlaValidation && !await AreAllHaplotypesValid(inputHaplotypes, hlaMetadataDictionary, typingCategory))
            {
