...
namespace Atlas.MatchPrediction.Services.HaplotypeFrequencies.Import
{
    ...
    {
        IEnumerable<HaplotypeFrequencyFileSchema> ImportHaplotypeFrequencyRecord(Stream stream);
    }

    internal class FrequencyCsvReader : IFrequencyCsvReader
    {
        public IEnumerable<HaplotypeFrequencyFileSchema> ImportHaplotypeFrequencyRecord(Stream stream)
        {
            ...
            using (var csv = new CsvReader(reader))
            {
                ...
                while (TryRead(csv))
                {
                    HaplotypeFrequencyFileSchema haplotypeFrequency = null;

                    try
                    {
                        haplotypeFrequency = csv.GetRecord<HaplotypeFrequencyFileSchema>();
                    }
                    ...
                    yield return new HaplotypeFrequencyFileSchema();
                }
            }
        }
        ...
        private sealed class HaplotypeFrequencyMap : ClassMap<HaplotypeFrequencyFileSchema>
        {
