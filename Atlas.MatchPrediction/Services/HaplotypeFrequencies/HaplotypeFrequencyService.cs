...
namespace Atlas.MatchPrediction.Services.HaplotypeFrequencies
{
    public interface IHaplotypeFrequencyService
    {
        ...
        /// <returns></returns>
        public Task ImportFrequencySet(FrequencySetFile file, FrequencySetImportConfig importConfig = null);
    ...
    internal class HaplotypeFrequencyService : IHaplotypeFrequencyService
    {
        ...
        public async Task ImportFrequencySet(FrequencySetFile file, FrequencySetImportConfig importConfig)
        {
            importConfig ??= new FrequencySetImportConfig();

            try
            {
                await frequencySetImporter.Import(file, importConfig);
