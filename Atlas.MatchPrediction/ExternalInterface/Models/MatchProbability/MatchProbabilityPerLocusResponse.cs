...
namespace Atlas.MatchPrediction.ExternalInterface.Models.MatchProbability
{
    public class MatchProbabilityPerLocusResponse
    {
        ...
        /// If zero percent chance of one mismatch, cant be any exact or potential so must be mismatch.
        ...
        /// <summary>
        /// If zero percent chance of two mismatches, other match category must be exact.
        /// If There is a chance of of two mismatches then neither of them can be exact so match category is potential.
        /// </summary>
