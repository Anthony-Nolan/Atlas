...
namespace Atlas.MatchPrediction.Test.Verification.Data.Repositories
{
    public interface ITestDonorExportRepository
    {
        ...
        Task AddRecord(int testHarnessId);
        Task UpdateLatestRecord(CompletedDataRefresh dataRefresh);
    }
    ...
    public class TestDonorExportRepository : ITestDonorExportRepository
    {
        ...
        public async Task AddRecord(int testHarnessId)
        {
        ...
        public async Task UpdateLatestRecord(CompletedDataRefresh dataRefresh)
        {
